...
class activity_visualizacao_dados : AppCompatActivity() {
    ...
    private fun botaoSalvarProducao(){
        val botaoSalvarProducao: Button = findViewById(R.id.botaoSalvarProducao)
        botaoSalvarProducao.setOnClickListener {
            startActivity(Intent(this, ActivitySalvarProducao::class.java))
        }
    }
